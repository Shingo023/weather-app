...
const DailyForecast = ({
  ...
  return (
    <div
      className={styles.dailyForecastWrapper} // New wrapper to ensure fixed positioning
...
//       {hovered && canScrollLeft && (
//         <div className={styles.arrowLeft} onClick={scrollLeft}>
//           <CircleChevronLeft className={styles.arrowIcon} />
//         </div>
//       )}
...
//       {hovered && canScrollRight && (
//         <div className={styles.arrowRight} onClick={scrollRight}>
//           <CircleChevronRight className={styles.arrowIcon} />
//         </div>
//       )}
//     </div>
//   );
